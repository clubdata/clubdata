<?php /* Smarty version 2.6.10, created on 2015-06-13 17:41:19
         compiled from formsgeneration/hidden.inc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('insert', 'formadddatapart', 'formsgeneration/hidden.inc.tpl', 3, false),array('insert', 'formaddinputhiddenpart', 'formsgeneration/hidden.inc.tpl', 5, false),)), $this); ?>
<?php ob_start(); ?><!--hidden-->
...
if ($this->_foreach['tabs']['total'] > 0):
 ...
 ob_start(); ?>
    <?php $this->_smarty_vars['capture']['formdata'] = ob_get_contents(); ob_end_clean();  require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
echo smarty_core_run_insert_handler(array('args' => array('name' => 'formadddatapart', 'data' => $this->_smarty_vars['capture']['formdata'])), $this);  if (( $this->_tpl_vars['button']['TYPE'] == 'hidden' || ( $this->_tpl_vars['button']['TYPE'] == 'text' && isset ( $this->_tpl_vars['button']['Accessible'] ) && $this->_tpl_vars['button']['Accessible'] == '0' ) )):  ob_start(); ?>
        <?php $this->_smarty_vars['capture']['formdata'] = ob_get_contents(); ob_end_clean();  require_once(SMARTY_CORE_DIR . 'core.run_insert_handler.php');
