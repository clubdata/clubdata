<?php /* Smarty version 2.6.10, created on 2011-01-05 20:11:48
         compiled from list.inc.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'default', 'list.inc.tpl', 2, false),array('modifier', 'cat', 'list.inc.tpl', 7, false),array('function', 'html_image', 'list.inc.tpl', 7, false),array('function', 'counter', 'list.inc.tpl', 57, false),)), $this); ?>
...
?>
        <th class="listTable" <?php if ($this->_tpl_vars['listObj']->sortColumn == $this->_sections['col']['index']): ?>id='listTableSortCol'<?php endif; ?>><?php echo $this->_tpl_vars['listObj']->listHeadRows[$this->_sections['row']['index']][$this->_sections['col']['index']]; ?>
</TH>
...
<?php endfor; else:  endif;  if (! empty ( $this->_tpl_vars['listObj']->listFooterRows )):  unset($this->_sections['row']);
$this->_sections['row']['name'] = 'row';
$this->_sections['row']['loop'] = is_array($_loop=$this->_tpl_vars['listObj']->listFooterRows) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['row']['show'] = true;
$this->_sections['row']['max'] = $this->_sections['row']['loop'];
$this->_sections['row']['step'] = 1;
$this->_sections['row']['start'] = $this->_sections['row']['step'] > 0 ? 0 : $this->_sections['row']['loop']-1;
...
$this->_sections['row']['last']       = ($this->_sections['row']['iteration'] == $this->_sections['row']['total']);
?>
    <?php if (( $this->_tpl_vars['class'] == 'odd' )): ?>
        <?php $this->assign('class', 'even'); ?>
    <?php else: ?>
        <?php $this->assign('class', 'odd'); ?>
    <?php endif; ?>
...
<tr>
 ...
 Footer" style='width: 1%;' >&nbsp;</TD>
    ...
    <?php unset($this->_sections['col']);
$this->_sections['col']['name'] = 'col';
$this->_sections['col']['loop'] = is_array($_loop=$this->_tpl_vars['listObj']->listFooterRows[$this->_sections['row']['index']]) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
$this->_sections['col']['show'] = true;
$this->_sections['col']['max'] = $this->_sections['col']['loop'];
$this->_sections['col']['step'] = 1;
$this->_sections['col']['start'] = $this->_sections['col']['step'] > 0 ? 0 : $this->_sections['col']['loop']-1;
...
?>
        <td class="<?php echo $this->_tpl_vars['class']; ?>
 Footer"><?php echo $this->_tpl_vars['listObj']->listFooterRows[$this->_sections['row']['index']][$this->_sections['col']['index']]; ?>
</td>
    <?php endfor; endif; ?>
</tr>
