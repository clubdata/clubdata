 ...
 *
 * If you plan to store backup files of Clubdata V2 on the server, you must set the path to
 * a directory which can be written by the webserver
 * For security reasons, this path should not be directly accessible via a browser, so it should be
 * located outside of $SERVER['DOCUMENT_ROOT']
 */
define("BACKUPDIR", "C:/windows/temp");
 ...
 */
define("DB_NAME", "Clubdata2");

/**
 * define name of database user
 */
define("DB_USER", "clubdata2");
