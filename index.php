...
if ( !defined('LINKROOT') )
{
	print(<<<END
			...
			Please run installation routine <a href="Installation/install.php">Installation/install.php</a>
			and copy<br><B>Installation/configuration.sample.php</B><br>to<br><B>include/configuration.php</B>
END
	);
	exit(1);
...
$module = getGlobVar('mod','settings|help|jobs|queries|main|members|search|list|fees|admin|payments|email|conferences','PG');
