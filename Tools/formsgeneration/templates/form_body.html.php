...
<table summary="Input fields table">
	...
	<tr>
		<th align="right"><?php $form->AddLabelPart(array("FOR"=>"email_notification")); ?>:</th>
		<td><?php $form->AddInputPart("email_notification"); ?></td>
		<td rowspan="2"><?php echo (IsSet($verify["email_notification"]) ? "[Verify]" : ""); ?></td>
	</tr>

	<tr>
		<th align="right"><?php $form->AddLabelPart(array("FOR"=>"phone_notification")); ?>:</th>
	...
	<tr>
		<th align="right"><?php $form->AddLabelPart(array("FOR"=>"administrator_subscription")); ?>:</th>
	...
	<tr>
		<th align="right"><?php $form->AddLabelPart(array("FOR"=>"user_subscription")); ?>:</th>
		<td><?php $form->AddInputPart("user_subscription"); ?></td>
	</tr>

	<tr>
		<th align="right"><?php $form->AddLabelPart(array("FOR"=>"guest_subscription")); ?>:</th>
	...
	if(!$doit)
	{
		?>
	<tr>
		<th align="right"><?php $form->AddLabelPart(array("FOR"=>"toggle")); ?>:</th>
	...
	<tr>
		<th align="right"><?php $form->AddLabelPart(array("FOR"=>"agree")); ?>:</th>
	...
	<tr>
		<td colspan="3" align="center"><?php $form->AddInputPart("image_subscribe"); ?>
		<?php $form->AddInputPart("button_subscribe"); $form->AddInputPart("doit"); ?></td>
	</tr>
	<?php
	}
?>
