<center>
<table summary="Validation error table" border="1" bgcolor="#c0c0c0"
	cellpadding="2" cellspacing="1">
	<tr>
		<td bgcolor="<?php echo $active ? '#000080': '#808080'; ?>"
...
<td><b>!</b></td>
			...
			<tr>
				<td>
				<table frame="box" bgcolor="#FF8000">
					<tr>
						<td><b>!</b></td>
					</tr>
				</table>
				...
				<table>
					<tr>
						<td><b>Please verify also the remaining fields marked with
						[Verify]</b></td>
					</tr>
				</table>
				</td>
