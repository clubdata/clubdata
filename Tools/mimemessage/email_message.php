 ...
 * email_message.php
 *
 * @(#) $Header: /cvsroot/clubdata/Clubdata2/include/mimemessage/email_message.php,v 1.1.1.1 2006/02/04 20:43:39 domes Exp $
 *
 *
 */
...
/*
 ...
 <version>@(#) $Id: email_message.php,v 1.1.1.1 2006/02/04 20:43:39 domes Exp $</version>
 ...
 <tt>multipart/related</tt> part with the HTML and the image parts
 using the <functionlink>CreateRelatedMultipart</functionlink>
 function, and then you add the <tt>multipart/alternative</tt> part to
 the message with the
 <functionlink>AddAlternativeMultipart</functionlink> function,
 passing an array of parts that lists first the text part and then the
 <tt>multipart/related</tt> part created before.<paragraphbreak />
