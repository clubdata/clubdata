 ...
 * qmail_message.php
 *
 * @(#) $Header: /cvsroot/clubdata/Clubdata2/include/mimemessage/qmail_message.php,v 1.1.1.1 2006/02/04 20:43:37 domes Exp $
 *
 *
 */
...
/*
 ...
 <version>@(#) $Id: qmail_message.php,v 1.1.1.1 2006/02/04 20:43:37 domes Exp $</version>
...
class qmail_message_class extends email_message_class
{
	...
	/*
	 ...
	 <variable>
		...
		<value>qmail $Revision: 1.1.1.1 $</value>
		<documentation>
		...
		{/metadocument}
		*/
	var $mailer_delivery='qmail $Revision: 1.1.1.1 $';
	...
	Function SendMailing($mailing)
	{
		...
		$headers=$this->FormatHeader("Date",gmstrftime("%d %b %Y %H:%M:%S -0000"))."\n";
